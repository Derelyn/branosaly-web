            ...
            <div className="perks">
                ...
                <div className="skills">
                    ...
                    <div>
                        ...
                        <p><strong>Git/Github</strong> - Basic</p>
                        <p><strong>Bootstrap</strong> - Basic</p>
                        <p><strong>MongoDB</strong> - Beginner</p>
                        <p><strong>Microsoft Office</strong> - Advanced</p>
                    </div>
                    <div>
                        <h2>Languages</h2>
                        <p><strong>English</strong> - C1</p>
                        <p><strong>German</strong> - A1</p>
                        <p><strong>Slovak/Czech</strong> - C2</p>
                    </div>
                    <div>
                        <h2>My other skills</h2>
                        <p><strong>Electrician</strong> - Advanced (Yes, I can repair you light/outlet at office)</p>
